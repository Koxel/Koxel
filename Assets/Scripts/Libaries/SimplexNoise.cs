...
namespace Simplex
{
    ...
    public class SimplexNoise
    {
        ...
        static SimplexNoise()
        {
            ...
            Simplex.SimplexNoise.permOriginal.CopyTo(perm, 0);
        }
        ...
        internal static float Generate(float x, float y)
        {
            ...
            float n0, n1, n2; // SimplexNoise contributions from the three corners
        ...
        internal static float Generate(float x, float y, float z)
        {
            ...
            float n0, n1, n2, n3; // SimplexNoise contributions from the four corners
